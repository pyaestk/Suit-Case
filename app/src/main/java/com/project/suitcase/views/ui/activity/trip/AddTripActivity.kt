package com.project.suitcase.views.ui.activity.trip
...
import com.project.suitcase.views.viewmodel.AddTripUiState
import com.project.suitcase.views.viewmodel.AddTripViewModel
import com.project.suitcase.views.viewmodel.AddTripViewModelEvent
...
class AddTripActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.btnSaveTrip?.setOnClickListener {
            val tripName = binding?.edtTripName?.text.toString().trim()

            if (tripName.isEmpty()) {
                Toast.makeText(this, "Please enter a trip name before saving", Toast.LENGTH_SHORT).show()
